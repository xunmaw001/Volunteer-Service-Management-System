    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="可报名人数" prop="huodongKucunNumber">
                       <el-input v-model="ruleForm.huodongKucunNumber"
                                 placeholder="可报名人数" clearable  :readonly="ro.huodongKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="可报名人数" prop="huodongKucunNumber">
                           <el-input v-model="ruleForm.huodongKucunNumber"
                                     placeholder="可报名人数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.statusTypes" label="活动状态" prop="statusTypes">
                        <el-input v-model="ruleForm.statusValue" placeholder="活动状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.jiezhiTime"  class="input" label="报名截止时间" prop="jiezhiTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiezhiTime" label="报名截止时间" prop="jiezhiTime">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   huodongKucunNumber: [
                              { required: true, message: '可报名人数不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
